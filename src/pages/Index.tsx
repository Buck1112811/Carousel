            ...
            >
              <CarouselContent className="-ml-4">
                {slides.map((slide, index) => (
                  <CarouselItem key={slide.id} className="basis-1/2 pl-4">
              ...
              {/* Custom Navigation */}
              <CarouselPrevious className="left-8 w-12 h-12 bg-black/60 border-white/20 text-white hover:bg-black/80 backdrop-blur-sm shadow-xl" />
              <CarouselNext className="right-8 w-12 h-12 bg-black/60 border-white/20 text-white hover:bg-black/80 backdrop-blur-sm shadow-xl" />
            </Carousel>
